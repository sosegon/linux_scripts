'''
    File name: fix_osm_errors.py

    Author: Sebastian Velasquez

    Date created: 2016/02/14

    Date last modified: 2016/02/14

    Python Version: 2.7

    License. The MIT License | https://opensource.org/licenses/MIT

    Description: The purpose of this script is to fix the errors in osm files
...
def process_errors_file(errors_file_name, source_file_name):
	...
	for line in f.readlines():
		if "Error:" in line:
			errors_array.append(line[6:].strip()+",")	
